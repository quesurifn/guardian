...
import {NAV_CLOSE} from './actions/action'
...
export class LeftNav extends Component {
  ...
  render() {
	...
	let items = this.props.cart.length > 0 ? this.props.cart.map((e) => 
		<div className="shopify-buy__cart-items" style={{overflowY: 'scroll'}} key={e._id}>
                <div className="shopify-buy__cart-item">
    ...
    return (
		<nav className="shopify-buy__cart sidenav" style={{zIndex: '99999'}}>
			...
			<div className="shopify-buy__cart-bottom">
			    ...
			    <p className="shopify-buy__cart__subtotal__price" style={{display:'block'}}>{subtotal}</p>
